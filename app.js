...
let examTimeLeft = 0;
let examStartTime = 0;
let examConfig = { singleCount: 60, multiCount: 100, judgeCount: 40, time: 100 };
...
const STREAK_MILESTONES = {
    5: [
        ...
        { emoji: '🔥', title: '5 连对！', msg: '知识正在成为你的本能' },
        { emoji: '🔥', title: '5 连对！', msg: '状态来了！保持这份手感' },
        { emoji: '🔥', title: '5 连对！', msg: '五题全对，说明你真的懂了' },
        { emoji: '🔥', title: '5 连对！', msg: '每一次准确，都是实力的体现' },
        { emoji: '🔥', title: '5 连对！', msg: '今天的你，正在变得更强' },
    ],
    10: [
        { emoji: '🚀', title: '10 连对！', msg: '当别人还在犹豫时，你已经在路上了' },
        { emoji: '🚀', title: '10 连对！', msg: '你的专注力，就是你最大的武器' },
        { emoji: '🚀', title: '10 连对！', msg: '十道题的背后，是无数次的思考与沉淀' },
        { emoji: '🚀', title: '10 连对！', msg: '连续十道，这就是稳定的力量' },
        { emoji: '🚀', title: '10 连对！', msg: '你的知识体系正在成型' },
        { emoji: '🚀', title: '10 连对！', msg: '十连对！你正在证明自己的实力' },
        { emoji: '🚀', title: '10 连对！', msg: '这种节奏感，就是高手的表现' },
        { emoji: '🚀', title: '10 连对！', msg: '坚持答对的每一题，都是你的底气' },
    ],
    20: [
        ...
        { emoji: '⚡', title: '20 连对！', msg: '二十连对！你的状态已经不是一般人能达到的' },
        { emoji: '⚡', title: '20 连对！', msg: '知识在你脑中已经形成了护城河' },
        { emoji: '⚡', title: '20 连对！', msg: '这份持续性，比爆发力更可怕' },
        { emoji: '⚡', title: '20 连对！', msg: '你正在用行动定义什么叫实力' },
        { emoji: '⚡', title: '20 连对！', msg: '不是运气，是日积月累的厚积薄发' },
    ],
    50: [
        { emoji: '👑', title: '50 连对！', msg: '五十连对，这不是运气，是绝对的实力' },
        { emoji: '👑', title: '50 连对！', msg: '你已经站在了大多数人到不了的高度' },
        { emoji: '👑', title: '50 连对！', msg: '天赋决定上限，努力决定下限，你在拉高下限' },
        { emoji: '👑', title: '50 连对！', msg: '半百连对，你就是别人口中的大神' },
        { emoji: '👑', title: '50 连对！', msg: '这种境界，需要实力和心态的双重支撑' },
        { emoji: '👑', title: '50 连对！', msg: '你已经证明了自己的绝对统治力' },
        { emoji: '👑', title: '50 连对！', msg: '五十道题，零失误，这就是你' },
        { emoji: '👑', title: '50 连对！', msg: '从量变到质变，你完成了蜕变' },
    ],
    100: [
        { emoji: '🏆', title: '100 连对！', msg: '一百连对，你就是传说本身' },
        { emoji: '🏆', title: '100 连对！', msg: '这种境界，已经不是努力能解释的了' },
        { emoji: '🏆', title: '100 连对！', msg: '你让不可能变成了可能' },
        { emoji: '🏆', title: '100 连对！', msg: '百题全对，前无古人的壮举' },
        { emoji: '🏆', title: '100 连对！', msg: '你已经超越了自己的极限' },
        { emoji: '🏆', title: '100 连对！', msg: '这一刻值得被铭记' },
        { emoji: '🏆', title: '100 连对！', msg: '一百道题，一百次正确，一百分的你' },
        { emoji: '🏆', title: '100 连对！', msg: '你就是这个题库的王者' },
    ],
};
...
const WRONG_STREAK_MILESTONES = {
    3: [
        ...
        { emoji: '💫', title: '别急', msg: '错误不可怕，可怕的是不知道自己错了' },
        { emoji: '💫', title: '别急', msg: '发现薄弱点，就是进步的开始' },
        { emoji: '💫', title: '别急', msg: '慢下来，想清楚，再出发' },
        { emoji: '💫', title: '别急', msg: '学习从来不是一帆风顺的，波折才正常' },
        { emoji: '💫', title: '别急', msg: '现在错了，总比考场上错好' },
        { emoji: '💫', title: '别急', msg: '错题暴露的是机会，不是缺陷' },
    ],
    5: [
        ...
        { emoji: '🌅', title: '稳住', msg: '黎明前的黑暗是最深的，但光明就在前方' },
        { emoji: '🌅', title: '稳住', msg: '这些错题，以后都会变成你的得分点' },
        { emoji: '🌅', title: '稳住', msg: '调整一下思路，换个角度来看' },
        { emoji: '🌅', title: '稳住', msg: '真正的勇士敢于直面惨淡的成绩' },
        { emoji: '🌅', title: '稳住', msg: '输不丢人，怕才丢人' },
        { emoji: '🌅', title: '稳住', msg: '每一道错题都在告诉你，哪里还需要加强' },
    ],
    8: [
        ...
        { emoji: '🔥', title: '坚持', msg: '越难的时候，越要沉住气' },
        { emoji: '🔥', title: '坚持', msg: '现在的痛苦，是未来甜蜜的伏笔' },
        { emoji: '🔥', title: '坚持', msg: '能扛住压力的人，才配得上成功' },
        { emoji: '🔥', title: '坚持', msg: '走过这段最难的路，你就脱胎换骨了' },
        { emoji: '🔥', title: '坚持', msg: '失败是成功的必经之路，你正在路上' },
        { emoji: '🔥', title: '坚持', msg: '挺过去，前面就是平坦大道' },
    ],
};
...
const DAILY_MILESTONES = {
    10:  [
        ...
        { emoji: '✨', title: '今日 10 题！', msg: '十道题，十分的你' },
        { emoji: '✨', title: '今日 10 题！', msg: '万事开头难，你已经迈出了第一步' },
        { emoji: '✨', title: '今日 10 题！', msg: '今天的学习之旅正式开始' },
        { emoji: '✨', title: '今日 10 题！', msg: '一个好的开始，等于成功了一半' },
    ],
    30:  [
        { emoji: '🔥', title: '今日 30 题！', msg: '你选择在这里拼搏的每一分钟，都在拉开与别人的距离' },
        { emoji: '🔥', title: '今日 30 题！', msg: '持续前行的人，终会到达彼岸' },
        { emoji: '🔥', title: '今日 30 题！', msg: '三十题！节奏已经起来了' },
        { emoji: '🔥', title: '今日 30 题！', msg: '你的专注力让你与众不同' },
        { emoji: '🔥', title: '今日 30 题！', msg: '知识正在一点一滴地积累' },
        { emoji: '🔥', title: '今日 30 题！', msg: '保持这个节奏，今天又是收获满满的一天' },
    ],
    50:  [
        { emoji: '💪', title: '今日 50 题！', msg: '半百之数，半是汗水，半是收获' },
        { emoji: '💪', title: '今日 50 题！', msg: '当你觉得坚持不下去的时候，恰恰是进步最快的时候' },
        { emoji: '💪', title: '今日 50 题！', msg: '五十题！你今天的付出不会白费' },
        { emoji: '💪', title: '今日 50 题！', msg: '坚持到这里的你，值得被尊敬' },
        { emoji: '💪', title: '今日 50 题！', msg: '今天的汗水就是明天的勋章' },
        { emoji: '💪', title: '今日 50 题！', msg: '你正在做的事，未来的你会感谢' },
    ],
    100: [
        { emoji: '🏅', title: '今日百题！', msg: '别人在休息的时候，你在默默变强' },
        { emoji: '🏅', title: '今日百题！', msg: '一百道题的重量，只有走过的人才懂' },
        { emoji: '🏅', title: '今日百题！', msg: '百题达成！今天的你值得一枚勋章' },
        { emoji: '🏅', title: '今日百题！', msg: '这份坚持，就是你和别人的差距' },
        { emoji: '🏅', title: '今日百题！', msg: '一百道题的积累，正在筑起你的知识城墙' },
        { emoji: '🏅', title: '今日百题！', msg: '你的努力不会说谎' },
    ],
    150: [
        { emoji: '⚡', title: '今日 150 题！', msg: '量变的积累，终将迎来质变的飞跃' },
        { emoji: '⚡', title: '今日 150 题！', msg: '你的坚持，正在重新定义你的极限' },
        { emoji: '⚡', title: '今日 150 题！', msg: '一百五十题！你的决心比钻石还硬' },
        { emoji: '⚡', title: '今日 150 题！', msg: '很少有人能做到你这样的程度' },
        { emoji: '⚡', title: '今日 150 题！', msg: '从一百到一百五，你又超越了自己' },
        { emoji: '⚡', title: '今日 150 题！', msg: '你正在成为那个别人追赶的人' },
    ],
    200: [
        { emoji: '🌟', title: '今日 200 题！', msg: '能走到这里的人，已经不多了' },
        { emoji: '🌟', title: '今日 200 题！', msg: '两百题的背后，是一个不甘平庸的灵魂' },
        { emoji: '🌟', title: '今日 200 题！', msg: '你的毅力让人敬佩' },
        { emoji: '🌟', title: '今日 200 题！', msg: '两百道题，两百次的自我突破' },
        { emoji: '🌟', title: '今日 200 题！', msg: '你已经跑赢了今天99%的人' },
        { emoji: '🌟', title: '今日 200 题！', msg: '坚持就是胜利，你就是最好的证明' },
    ],
    250: [
        { emoji: '🔥', title: '今日 250 题！', msg: '你的坚持，终将成就不凡的你' },
        { emoji: '🔥', title: '今日 250 题！', msg: '这份毅力，比知识本身更有价值' },
        { emoji: '🔥', title: '今日 250 题！', msg: '你在挑战自己的极限，而且你赢了' },
        { emoji: '🔥', title: '今日 250 题！', msg: '别人在看手机的时候，你在刷题' },
        { emoji: '🔥', title: '今日 250 题！', msg: '你的自律程度已经超乎想象' },
    ],
    300: [
        { emoji: '🚀', title: '今日 300 题！', msg: '三百题！势如破竹，无人能挡' },
        { emoji: '🚀', title: '今日 300 题！', msg: '当你回头看今天，会感谢此刻拼搏的自己' },
        { emoji: '🚀', title: '今日 300 题！', msg: '三百道题的厚度，就是你实力的底色' },
        { emoji: '🚀', title: '今日 300 题！', msg: '你正在创造属于自己的记录' },
        { emoji: '🚀', title: '今日 300 题！', msg: '这个数字本身就是一种荣耀' },
    ],
    350: [
        { emoji: '💎', title: '今日 350 题！', msg: '钻石般的意志力，注定不会平凡' },
        { emoji: '💎', title: '今日 350 题！', msg: '你在做的事，大多数人坚持不了' },
        { emoji: '💎', title: '今日 350 题！', msg: '你的名字应该写在勤奋的字典里' },
        { emoji: '💎', title: '今日 350 题！', msg: '坚持到这里，你已经是强者' },
        { emoji: '💎', title: '今日 350 题！', msg: '三百五十题的重量，你抗住了' },
    ],
    400: [
        { emoji: '👑', title: '今日 400 题！', msg: '你的人生，由你自己定义' },
        { emoji: '👑', title: '今日 400 题！', msg: '四百题！只有真正热爱的人才能到达这里' },
        { emoji: '👑', title: '今日 400 题！', msg: '你今天的表现堪称完美' },
        { emoji: '👑', title: '今日 400 题！', msg: '四百道题铸就的实力，无人能及' },
        { emoji: '👑', title: '今日 400 题！', msg: '你就是自己生命的王者' },
    ],
    450: [
        { emoji: '⭐', title: '今日 450 题！', msg: '努力到无能为力，拼搏到感动自己' },
        { emoji: '⭐', title: '今日 450 题！', msg: '你已经证明了自己的决心和毅力' },
        { emoji: '⭐', title: '今日 450 题！', msg: '你今天的状态，就是巅峰' },
        { emoji: '⭐', title: '今日 450 题！', msg: '没有人能否定你付出的努力' },
        { emoji: '⭐', title: '今日 450 题！', msg: '你燃烧的热情，足以照亮整个夜空' },
    ],
    500: [
        { emoji: '🏔️', title: '今日 500 题！', msg: '你正在攀登的高峰，终会成为脚下的平地' },
        { emoji: '🏔️', title: '今日 500 题！', msg: '半千之数，此刻的你正在书写属于自己的传奇' },
        { emoji: '🏔️', title: '今日 500 题！', msg: '五百道题！你今天创造了历史' },
        { emoji: '🏔️', title: '今日 500 题！', msg: '这座山你已经翻过了大半' },
        { emoji: '🏔️', title: '今日 500 题！', msg: '你的名字今天值得被记住' },
    ],
    550: [
        { emoji: '🔥', title: '今日 550 题！', msg: '你的努力终将照亮前方的路' },
        { emoji: '🔥', title: '今日 550 题！', msg: '距离巅峰只有一步之遥，不要停下' },
        { emoji: '🔥', title: '今日 550 题！', msg: '五百五十题！你是今天最努力的人' },
        { emoji: '🔥', title: '今日 550 题！', msg: '终点就在前方，冲刺吧' },
        { emoji: '🔥', title: '今日 550 题！', msg: '你已经比绝大多数人走得更远' },
    ],
    600: [
        { emoji: '🏆', title: '今日 600 题！', msg: '六百题！今日之王！你的名字值得被记住' },
        { emoji: '🏆', title: '今日 600 题！', msg: '这一刻，你就是最好的自己' },
        { emoji: '🏆', title: '今日 600 题！', msg: '六百道题！这是属于你的荣耀时刻' },
        { emoji: '🏆', title: '今日 600 题！', msg: '你用行动证明了什么叫做极致' },
        { emoji: '🏆', title: '今日 600 题！', msg: '今天的你，值得全世界的掌声' },
    ],
};
...
function renderPracticeQuestion() {
    ...
    // Update practice quote (changes every 5 questions, randomized per session)
    const quoteEl = document.getElementById('practiceQuote');
    if (quoteEl) {
        const groupIndex = Math.floor(practiceIndex / 5);
        // Mix group index with a session-random seed for different quotes each time
        if (!window._quoteSessionSeed) window._quoteSessionSeed = Math.floor(Math.random() * DAILY_QUOTES.length);
